public class PersonnummerChecker extends ValidityChecker{
    private boolean leapYear = false;
    private boolean plussign = false;

    PersonnummerChecker(String id){
        super(id);
    ...
    public boolean validation(){
        if(!(this.getAmount() == 10 || this.getAmount() == 12) || !this.luhn() || !this.checkFormat()){
            System.out.println("Ogiltig personnummer: " + this.getId());
            return false;
        }
        ...
        else if(this.getLeapYear() && month == 2 && day > 29){
            System.out.println("Ogiltig personnummer: " + this.getId());
            return false;
        }
        ...
        System.out.println("Giltig personnummer: " + this.getId());
        return true;
    }
} 